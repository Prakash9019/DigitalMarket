...
const PricingCard = ({ title, description, price, buttonText, isFreeTier }) => {
  const cardClasses = isFreeTier
    ? "flex flex-col grow items-start px-4 pt-4 pb-7 w-full text-2xl font-extrabold text-black rounded-xl border border-yellow-800 border-solid bg-zinc-100 max-md:mt-6"
    : "flex flex-col grow px-4 pt-4 pb-7 text-2xl font-extrabold text-white rounded-xl max-md:mt-6";
